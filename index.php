        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="pages/courses_visitor.php" class="nav-item nav-link active">Courses</a>
                    <a href="pages/login.php" class="nav-item nav-link">Sign In</a>
                </div>
                <a href="pages/register.php" class="btn btn-primary py-2 px-4 d-none d-lg-block">Sign Up</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
            ...
            <div class="mx-auto mb-5" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <button class="btn btn-outline-light bg-white text-body px-4" type="button" data-toggle="dropdown"
